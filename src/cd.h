...
extern char* cdVersion(void);
extern char* cdVersionDate(void);
extern int cdVersionNumber(void);

/* canvas init */
extern cdCanvas* cdCreateCanvas(cdContext *context, void *data);
extern cdCanvas* cdCreateCanvasf(cdContext *context, const char* format, ...);
extern void cdKillCanvas(cdCanvas* canvas);
